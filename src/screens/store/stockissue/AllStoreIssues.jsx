...
import { useGetAllStockIssuesQuery } from "../../../slices/store/stockAdjustmentHeadersApiSlice";
...
const AllStoreIssues = () => {
  ...
  const { data: stockAdj, isLoading } = useGetAllStockIssuesQuery();
