...
import { useDailyProductionReportMutation } from "../../slices/production/productionHeaderApiSlice";
...
const ProductionReportScreen = () => {
  ...
  const columns1 = useMemo(
    () => [
      ...
      { Header: "Batch_number", accessor: "batch_number" },
      {
        Header: "Date",
      ...
      { Header: "Input", accessor: "production_input" },
      { Header: "Expected", accessor: "expected_output" },
      { Header: "Output ", accessor: "actual_output" },
      { Header: "Variance", accessor: "production_variance" },
      { Header: "Item", accessor: "item_name" },
      { Header: "Produced", accessor: "product_output" },
    ],
    []
  );
          ...
          <Col>
            <Form.Group className="my-2" controlId="role_name">
              ...
              >
                ...
                <option value="combined">Daily Production Combined</option>
                <option value="general">Daily Production General</option>
                <option value="detailed">Daily Production Detailed</option>
              </Form.Select>
            </Form.Group>
          </Col>
          <Col>
...
export default ProductionReportScreen;
