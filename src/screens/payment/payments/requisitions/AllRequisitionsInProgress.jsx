...
import { useGetAllRequisitionHeadersInProgressQuery } from "../../../../slices/payment/requisitionHeaderApiSlice";
...
import { IoAccessibilitySharp, IoAnalytics, IoExpand } from "react-icons/io5";
import { MdEdit } from "react-icons/md";

const AllRequisitionsInProgress = () => {
  ...
  const { data, isLoading } = useGetAllRequisitionHeadersInProgressQuery();
  useEffect(() => {
    if (data?.data) {
  ...
  return (
    <>
      <p>*** Requisition in progress List ***</p>
      <DataTable columns={columns} data={tableData} />
    </>
  );
};
export default AllRequisitionsInProgress;
